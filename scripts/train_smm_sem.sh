...
torchrun \
  ...
  --dataset_config_file ./data/configs/example_smm_sem_text_mv.yaml \
  ...
  --checkpoint_dir /lustre/fsw/portfolios/nvr/users/ymingli/projects/ybq/results/checkpoints_smm_sem_text_mv/ \
  --max_checkpoints 2 \
  > run_mv_sem.out 2> run_mv_sem.err
